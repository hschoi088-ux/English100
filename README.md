...
<head>
    ...
    <style>
        ...
        .en-text { 
            ...
            color: #444; 
            line-height: 1.6; 
            word-break: break-word; /* 너무 긴 영어 단어도 카드 안에서 줄바꿈 */
...
<body oncontextmenu="return false" onselectstart="return false" ondragstart="return false">
    ...
    <div id="setup-screen">
        <h1>🎓 영어회화100</h1>
        <p class="desc">범위를 선택하면 랜덤 8문제가 출제됩니다.</p>
    ...
    <script>
        ...
        const allData = [
            // Day 1 ~ 25 데이터 전체 수록 (72개 문장)
            { d: 1, kr: "재택근무는 저랑 안 맞아요.", en: "Working from home [isn’t] [for] [me].", sum: "개인적 성향/취향에 맞지 않음을 나타냅니다." },
            { d: 1, kr: "선생님 할 생각은 해 보셨나요?", en: "No, no. Teaching [isn’t] [really] [for] [me].", sum: "be for: 성향상 나에게 맞는지 여부를 뜻합니다." },
            ...
            { d: 2, kr: "하루빨리 함께 일하고 싶습니다.", en: "I [look] [forward] [to] working with you.", sum: "look forward to: 기대감을 나타내는 정중한 표현입니다." },
            { d: 3, kr: "죄송한데 조금 짧게 해 주시겠어요?", en: "[Do] [you] [mind] keeping it a bit short?", sum: "Do you mind: 공손하게 부탁하거나 허락을 구하는 표현입니다." },
            { d: 3, kr: "에어컨 좀 약하게 하면 안 될까요?", en: "[Do] [you] [mind] turning down the air-conditioning?", sum: "상대의 의사를 존중하는 정중한 질문입니다." },
            { d: 3, kr: "미안하지만 좀 도와주실 수 있을까요?", en: "[Would] [you] [mind] giving me a hand?", sum: "Would you mind: 더 한층 정중한 격식체입니다." },
            ...
            { d: 5, kr: "공포 영화 어때?", en: "[How] [do] [you] [feel] [about] horror movies?", sum: "How do you feel about: 주제나 제안에 대한 선호도를 묻습니다." },
            ...
            { d: 8, kr: "오늘 속이 좀 안 좋아서 저녁 안 먹을래.", en: "My stomach [doesn’t] [feel] [quite] [right] [today].", sum: "몸의 특정 부위가 불편함을 부드럽게 표현합니다." },
            ...
            { d: 9, kr: "커피 사다 드릴까요?", en: "[Would] [you] [like] [me] [to] grab you some coffee?", sum: "Would you like me to: 공손하게 도움이나 행동을 제안합니다." },
            ...
            { d: 11, kr: "대학원 진학을 고민하고 있어요.", en: "I [was] [thinking] [of] going to translation grad school.", sum: "was thinking of: ~할까 생각 중이다라는 부드러운 계획 표현." },
            { d: 11, kr: "다음 여행은 몽골을 생각 중이었는데 안 가기로 했습니다.", en: "I [was] [thinking] [of] Mongolia for my next trip.", sum: "과거 진행형으로 조심스러운 계획을 나타냅니다." },
            { d: 11, kr: "회의를 잡았으면 합니다.", en: "I [was] [hoping] [to] set up a meeting.", sum: "was hoping to: ~하기를 바라고 있었다는 공손한 어조입니다." },
            ...
            { d: 18, kr: "어젯밤에 무슨 일이 있었던 거야?", en: "[Speaking] [of] [which], what happened last night?", sum: "Speaking of which: 방금 언급된 주제로 말을 이어갈 때 씁니다." },
            { d: 18, kr: "이번 가을은 유난히 따뜻했어.", en: "[Speaking] [of] [the] [weather], this autumn was warm.", sum: "특정 화제를 연결 고리로 대화를 이어갑니다." },
            ...
            { d: 23, kr: "강남에서는 커피가 너무 비싸다.", en: "Coffee is [overpriced] in Gangnam.", sum: "overpriced: 가치에 비해 가격이 과하게 책정됨." },
            { d: 24, kr: "싼 게 다 그렇지 뭐.", en: "[You] [get] [what] [you] [pay] [for].", sum: "지불한 만큼 얻는다, 즉 싼 게 비지떡이라는 의미입니다." },
            { d: 24, kr: "싼 게 비지떡이죠.", en: "[You] [get] [what] [you] [pay] [for].", sum: "품질과 가격의 상관관계를 말하는 속담 같은 표현입니다." },
        ...
        function nextQuestion() {
            ...
            if (currentIndex < currentQuestions.length) {
                ...
                alert("🎉 모든 문제를 마쳤습니다! 초기 화면으로 돌아갑니다.");
                location.reload();
            }
        }
    </script>
